...
int main()
{
  ...
  // Load mesh from file
  auto mesh = std::make_shared<Mesh>("/home/leeiozh/miptbot/proga/infa4sem/lab3/inp/lshape.xml.gz");
  ...
  auto zero = std::make_shared<Constant>(0.1);
  auto zero_vector = std::make_shared<Constant>(0.1, -0.1);
  ...
  File ufile("/home/leeiozh/miptbot/proga/infa4sem/lab3/out/velocity_.pvd");
  File pfile("/home/leeiozh/miptbot/proga/infa4sem/lab3/out/pressure_.pvd");
